    ...
    <section className="max-w-5xl mx-auto py-12 px-6 mt-16">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 flex items-start gap-4 mb-6">
        ...
        <div>
          ...
          <button className="mt-2 px-4 py-2 bg-teal-500 text-white text-sm font-medium rounded-lg shadow hover:bg-teal-600 transition">
      ...
      <div className="mt-10 text-center text-gray-500 text-sm flex items-center justify-center gap-2">
        <span>🔒</span>
        <p>Data Anda Aman & Privasi Terjamin</p>
      </div>
    </section>
  );
}
