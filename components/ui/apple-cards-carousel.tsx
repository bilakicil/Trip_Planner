  ...
  const scrollLeft = () => {
    if (carouselRef.current) {
      const scrollDistance =
        window.innerWidth < 640 ? 200 : window.innerWidth < 1024 ? 250 : 300;
  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-4 sm:mr-6 md:mr-10 flex justify-end gap-1 sm:gap-2">
          <button
  ...
  return (
    <>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            <motion.div
              ...
              className="relative z-[60] mx-auto my-4 sm:my-6 md:my-10 h-fit max-w-5xl rounded-3xl bg-white p-3 sm:p-4 md:p-10 font-sans dark:bg-neutral-900"
            >
              <button
              ...
              <motion.p
                ...
                className="mt-2 sm:mt-4 text-xl sm:text-2xl md:text-5xl font-semibold text-neutral-700 dark:text-white"
              >
                {card.title}
              </motion.p>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-64 w-48 sm:h-72 sm:w-52 md:h-80 md:w-56 lg:h-[30rem] lg:w-64 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 dark:bg-neutral-900"
      >
        <div className="pointer-events-none absolute inset-x-0 top-0 z-30 h-full bg-gradient-to-b from-black/50 to-transparent" />
        <div className="relative z-40 p-4 sm:p-6 md:p-8">
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="mt-1 sm:mt-2 max-w-xs text-left font-sans text-lg sm:text-xl md:text-2xl font-semibold [text-wrap:balance] text-white"
          >
            {card.title}
          </motion.p>
        </div>
